    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4">
            ...
            <div className="neo-card flex flex-col items-start gap-5 w-full max-w-[400px]">
                ...
                <button className="neo-btn w-full justify-start pl-8 group">
                    <svg className="w-6 h-6 mr-3 group-hover:text-white transition-colors" viewBox="0 0 24 24">
                ...
                <button className="neo-btn w-full justify-start pl-8 group">
                    <svg className="w-6 h-6 mr-3 text-[var(--text-primary)] group-hover:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="w-full flex items-center justify-center gap-2">
                    <div className="h-[3px] w-[100px] bg-[var(--text-secondary)] rounded-full"></div>
                    <span className="text-[var(--text-primary)] font-bold text-sm">OR</span>
                    <div className="h-[3px] w-[100px] bg-[var(--text-secondary)] rounded-full"></div>
                </div>
